...
public class TelefonoController {
    ...
    public ResponseEntity<List<TelefonoDTO>> getTelefonosByInformeId(@PathVariable Long informeId) {
        List<TelefonoDTO> telefonos = telefonoService.getTelefonosByInformeId(informeId);
